  ...
  return (
    <>
      <div className="flex flex-wrap lg:flex-nowrap">
        ...
        <div className="w-full h-dvh content-center px-10">
          <AnimatedShinyTextDemo />
          <SparklesTextDemo />
          <span className="text-2xl md:text-4xl lg:text-7xl font-bold">I'am </span>
          <span className="text-2xl md:text-4xl lg:text-7xl font-bold bg-gradient-to-r from-orange-700 via-blue-500 to-green-400 text-transparent bg-clip-text animate-gradient">
            SOURAV
          </span>
